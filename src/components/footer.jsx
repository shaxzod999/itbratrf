...
export default function Footer() {
  ...
  return (
    <div className="flex justify-center w-full bg-main-black bg1">
      <div className="md:max-w-[1196px] w-full flex flex-col-reverse items-center gap-[77px] justify-between md:flex-row  md:mt-[200px] mt-0 pb-12">
        <div className="flex items-center justify-between w-full md:w-1/2">
          ...
          <ul className="flex flex-col gap-2 p-5 text-[clamp(8px,3vw,14px)] ">
              ...
              <li
                onClick={() => navigate("/")}
                className="text-second-color hover:text-main-red"
              >
                <a href="#home">Главная</a>
              </li>
              <li className="text-second-color hover:text-main-red">
          ...
          <div>
            <ul className="flex flex-col gap-2 p-5 text-[clamp(8px,3vw,14px)] ">
              ...
              <li className="text-second-color hover:text-main-red">
                <a href="/rules-of-the-site">Правила</a>
              </li>
